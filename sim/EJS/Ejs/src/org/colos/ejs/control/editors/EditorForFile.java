...
public class EditorForFile {
  ...
  public static String edit (Osejs _ejs, Component parent, String _extension) {
    String[] sel = edit (_ejs, parent, _extension, false, false);
    if (sel==null) return null;
    return sel[0];
  }

  public static String edit (Osejs _ejs, Component parent, String _extension, String _title) {
    String[] sel = edit (_ejs, parent, _extension, false, false, _title);
    if (sel==null) return null;
    return sel[0];
  }

  public static String[] edit (Osejs _ejs, Component parent, String _extension, 
      boolean _multipleFiles, boolean _allowDirectories) {
    return edit (_ejs, parent, _extension,_multipleFiles, _allowDirectories,null);
  }
  ...
  public static String edit (Osejs _ejs, String _title, Component parent, String _description, String _extensions) {
    ...
    if (_extensions.equals("image") || _extensions.equals("imageFile") || _extensions.equals("selectedimage") ||
        _extensions.equals("imageOn") || _extensions.equals("imageOff")) { // add the OSP icons
  ...
  public static String[] edit (Osejs _ejs, Component parent, String _extension, boolean _multipleFiles, boolean _allowDirectories, String _title) {
    _ejs.saveXMLFileFirst(parent);
    ...
    if (_extension.equals("image") || _extension.equals("imageFile") || _extension.equals("selectedimage") ||
        _extension.equals("imageOn") || _extension.equals("imageOff")) { // add the OSP icons
      fileDialog.setAccessory(OSPImagesAccesory.getScrollPanel());
    }
