...
//    buttonPanel.add (defaultButton);
    ...
    addColor (colorCenterPanel, "200,220,208",    new Color(200,220,208), mouseListener);// FKH 021103
    ...
    for (int r=0; r<=256; r+=64) {
      ...
      for (int g=0; g<=256; g+=64) {
        ...
        for (int b=0; b<=256; b+=64) {
          if (b>255) b = 255;
          addColor (moreColorsPanel, r+","+g+","+b, new Color (r,g,b), mouseListener);
        }
      }
    }
    dialog2 = new JDialog();
...
//  }
//
//  public static String edit (String _property, JTextField returnField) {
