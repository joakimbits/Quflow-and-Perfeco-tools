...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      ...
      case 3 : histogram.setBinColor (fillColor,lineColor=(Color)_value.getObject()); break;
      case 4 : histogram.setBinColor (fillColor=(Color)_value.getObject(),lineColor); break;
