...
public class ControlCamImage extends ControlInteractiveElement {
  static protected final int CAM_IMAGE_ADDED = 3; // Number of new properties
...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    ...
    switch (_index) {
      case  0 : setConnection(_value.getString(), videoClass.getMJPEG(), videoClass.getDelay()); break;
      case  1 : setConnection(videoClass.getURL(), _value.getBoolean(), videoClass.getDelay()); break;
      case  2 : setConnection(videoClass.getURL(), videoClass.getMJPEG(), _value.getInteger()); break;
  ...
  public Value getValue (int _index) {
    //System.out.println("Pasa por getValue");
    switch (_index) {
...
// -------------------------------------
  ...
  private void setConnection (String url, boolean mjpeg, int delay){
    ...
    if (url != null) {
        if ((!url.equals(_url)) || (mjpeg != _mjpeg) || (delay != _delay)){
            _url = url;
            _mjpeg = mjpeg;
            _delay = delay;
