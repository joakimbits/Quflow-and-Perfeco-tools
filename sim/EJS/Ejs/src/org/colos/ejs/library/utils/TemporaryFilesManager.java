...
//      System.out.println ("Created dir "+tmpDir.getAbsolutePath());
   ...
   * @param _targetDirectory Th etarget directory to save the extracted files
   * @param _label An optional JLabel to display messages
   * @param _prefix A prefix to preprend to the extracted file in order to create the message
   * @return the Set of extracted files
   */
