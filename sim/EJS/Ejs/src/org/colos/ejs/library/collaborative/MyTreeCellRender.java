...
public class MyTreeCellRender extends JLabel implements TreeCellRenderer {
    ...
    //Icons
    static protected ImageIcon collapsedIconStudent;
    static protected ImageIcon expandedIconStudent;
    static protected ImageIcon collapsedIconRoot;
    static protected ImageIcon expandedIconRoot;
