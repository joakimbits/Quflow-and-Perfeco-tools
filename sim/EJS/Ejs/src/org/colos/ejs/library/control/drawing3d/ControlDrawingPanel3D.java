...
public class ControlDrawingPanel3D  extends ControlSwingElement implements NeedsUpdate, NeedsFinalUpdate, ControlParentOfElement3D,
        InteractionListener, SpecialRender, HasEditor {
...
//      System.err.println ("Setting "+_index+" to "+_value);
    ...
    switch (_index) {
      ...
      case 14 : 
        if (_value.getInteger()!=drawingPanel3D.getImplementation()) {
          if (drawingPanel3D.setImplementation(_value.getInteger())) { // true if successfull
            setListeners();
  ...
  public void setDefaultValue (int _index) {
    switch (_index) {
      ...
      case 40 : visHints.setBackgroundImage(null); break;
