...
public abstract class ControlSwingElement extends ControlElement {
  ...
  //static public final int MOUSE_DRAGGED_ACTION   = 34; Use ControlElement.VARIABLE_CHANGED instead
...
// ------------------------------------------------
  ...
  */
   ...
   */
   ...
   protected void getPopupMenu (int x, int y) { getSimulation().getPopupMenu(getVisual(),x,y,getPrintTarget()); }
...
//    System.out.println ("Looking for icon "+_iconFile);
    if (_iconFile.startsWith("\"") && _iconFile.endsWith("\"")) _iconFile = _iconFile.substring(1,_iconFile.length()-1);
//    System.out.println ("    Actually for icon <"+_iconFile+">");
    javax.swing.ImageIcon icon =  org.opensourcephysics.tools.ResourceLoader.getIcon(_iconFile);
    return icon;
  }
