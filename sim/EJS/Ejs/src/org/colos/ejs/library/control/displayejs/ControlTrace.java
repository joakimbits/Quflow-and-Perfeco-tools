...
// ------------------------------------------------
  ...
  public String getPropertyInfo(String _property) {
    ...
    if (_property.equals("z"))   return "int|double|double[] DEPRECATED";
    ...
    if (_property.equals("positionz"))   return "int|double DEPRECATED";
    ...
    if (_property.equals("zLabel"))    return "String TRANSLATABLE DEPRECATED";
