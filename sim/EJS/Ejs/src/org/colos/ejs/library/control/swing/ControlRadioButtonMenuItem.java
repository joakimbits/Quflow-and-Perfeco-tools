...
// ------------------------------------------------
      ...
      public void setValue (int _index, Value _value) {
        switch (_index) {
          case 0 : if (!_value.getString().equals(menuAcc))
                     ((JRadioButtonMenuItem)radioButton).setAccelerator(KeyStroke.getKeyStroke(menuAcc=_value.getString())); break;
      ...
      public void setDefaultValue (int _index) {
        switch (_index) {
          case 0 : menuAcc=null; ((JRadioButtonMenuItem)radioButton).setAccelerator(null); break;
