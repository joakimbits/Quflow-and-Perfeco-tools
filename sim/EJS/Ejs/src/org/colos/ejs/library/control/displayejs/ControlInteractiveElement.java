...
// ------------------------------------------------
  ...
  public String getPropertyInfo(String _property) {
    ...
    if (_property.equals("z"))           return "int|double DEPRECATED";
    if (_property.equals("sizex"))       return "int|double|double[]";
    if (_property.equals("sizey"))       return "int|double";
    if (_property.equals("sizez"))       return "int|double  DEPRECATED";
    ...
    if (_property.equals("scalez"))         return "int|double DEPRECATED";
    ...
    if (_property.equals("resolution"))     return "Resolution|String|Object DEPRECATED";
