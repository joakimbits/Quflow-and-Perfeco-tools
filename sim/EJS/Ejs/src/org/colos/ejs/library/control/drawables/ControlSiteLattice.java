...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      case 0 : if (_value.getDouble()!=minX) lattice.setXMin(minX=_value.getDouble()); break;
      case 1 : if (_value.getDouble()!=maxX) lattice.setXMax(maxX=_value.getDouble()); break;
      case 2 : if (_value.getDouble()!=minY) lattice.setYMin(minY=_value.getDouble()); break;
      case 3 : if (_value.getDouble()!=maxY) lattice.setYMax(maxY=_value.getDouble()); break;
      case 4 :
