...
public class ListStudentsTree {
    ...
    */
    public  ListStudentsTree(Dimension dim,SimulationCollaborative simulation, int port) {
	    this.dim = dim;
	    this.sim = simulation;
	    this.port = port;
	    try {
	    ...
	    server = new ServerEJS(mySession,this.port);
    }
	...
	*/
	protected static ListStudentsTree getTool(SimulationCollaborative simulation, int port) 
    {
	   if (STUDENT_TREE==null){STUDENT_TREE = new ListStudentsTree(defaultSize,simulation,port);}
	   return STUDENT_TREE;
	}
	...
	* @return ListStudentsTree Object Interface
	*/
	protected static ListStudentsTree getTool(Dimension dim,SimulationCollaborative simulation,int port) 
	{
	   if (STUDENT_TREE==null){STUDENT_TREE = new ListStudentsTree(dim,simulation,port);}
		   return STUDENT_TREE;
	} 
	...
	*/
    private void createGUI(){
    	...
    	mainframe = new JFrame("Students' List");
    	...
    	DefaultMutableTreeNode root = createNewNode("Teacher",null);
	...
	*/
    protected JMenuBar performMenuBar() 
    {
    	...
    	menuItemDisconnect = menu.add(new JMenuItem("Disconnect"));
    	menuItemConnect = menu.add(new JMenuItem("Connect"));   
    	...
    	menuItemRemoveStudent = menu.add(new JMenuItem("Remove Student"));
    	menuItemRemoveStudent.addActionListener(new RemoveAction());

    	menuItemGive = menu.add(new JMenuItem("Give the chalk"));
    	menuItemRemove = menu.add(new JMenuItem("Remove the chalk"));
