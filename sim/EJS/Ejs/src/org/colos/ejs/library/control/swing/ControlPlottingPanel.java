...
public class ControlPlottingPanel extends ControlDrawablesParent implements InteractiveMouseHandler {
  static final protected int ADDEDBYPLOTTINGPANEL = 46;
  ...
  static private final int MENU = 45;
...
// ------------------------------------------------
  ...
  public String getPropertyInfo(String _property) {
    ...
    if (_property.equals("gutters"))        return "Margins|Object";
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      ...
      case ALIASING : 
        ...
        break;
      case MENU : enableMenu = _value.getBoolean(); break;
  ...
  public void setDefaultValue (int _index) {
    switch (_index) {
      ...
      case ALIASING : 
        ...
        break;
      case MENU : enableMenu = true; break;
