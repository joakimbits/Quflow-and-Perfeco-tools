...
// ------------------------------------------------
    ...
    public void setValue (int _index, Value _value) {
      switch (_index) {
        case 0 : if (!_value.getString().equals(menuAcc))
                   ((JCheckBoxMenuItem)checkbox).setAccelerator(KeyStroke.getKeyStroke(menuAcc=_value.getString())); break;
    ...
    public void setDefaultValue (int _index) {
      switch (_index) {
        case 0 : menuAcc=null; ((JCheckBoxMenuItem)checkbox).setAccelerator(null); break;
