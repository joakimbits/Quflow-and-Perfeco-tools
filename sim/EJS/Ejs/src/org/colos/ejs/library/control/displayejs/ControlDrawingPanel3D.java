...
// ------------------------------------------------
  ...
  public String getPropertyInfo(String _property) {
    if (_property.equals("autoscaleX"))     return "boolean DEPRECATED";
    if (_property.equals("autoscaleY"))     return "boolean";
    if (_property.equals("autoscaleZ"))     return "boolean";
    if (_property.equals("minimumX"))       return "int|double DEPRECATED";
    ...
    if (_property.equals("name"))       return "String DEPRECATED CONSTANT";
