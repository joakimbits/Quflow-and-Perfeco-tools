...
//------------------------------------------------
    ...
    switch (_index) {
      case 0 : 
        if (_value.getObject() instanceof String[]) {
          ...
          for (int i=0, n=Math.min(numElements,val.length); i<n; i++) ((ElementText)elements[i]).setText(val[i]);
        }
        else {
      ...
      case 1 : 
        if (_value.getObject() instanceof Object[]) {
          ...
          for (int i=0, n=Math.min(numElements,val.length); i<n; i++) ((ElementText)elements[i]).setFont((Font)val[i]);
        }
        else {
          Font val = (Font) _value.getObject();
          for (int i=0; i<numElements; i++) ((ElementText)elements[i]).setFont(val);
        }
        break;
      case 2 : 
  ...
  public void setDefaultValue (int _index) {
    switch (_index) {
      ...
      case 3 : for (int i=0; i<numElements; i++) elements[i].getStyle().setRelativePosition(Style.CENTERED); break; 
