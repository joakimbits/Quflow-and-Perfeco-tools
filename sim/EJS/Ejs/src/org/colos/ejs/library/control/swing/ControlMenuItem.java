...
public class ControlMenuItem extends ControlSwingElement {
  ...
  private String imageFile = null, menuAcc=null, labelString="";
...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      ...
      case 3 : // action
        ...
        break;
      case 4 : if (!_value.getString().equals(menuAcc))
                 menuItem.setAccelerator(KeyStroke.getKeyStroke(menuAcc=_value.getString())); break;
  ...
  public void setDefaultValue (int _index) {
    switch (_index) {
      ...
      case 4 : menuAcc=null; menuItem.setAccelerator(null); break;
