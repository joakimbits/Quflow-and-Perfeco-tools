...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      ...
      case 1 : if (_value.getBoolean()!=image.isTrueSize()) image.setTrueSize(_value.getBoolean()); break;
      case 2 : if (_value.getInteger()!=image.getStyle().getRelativePosition()) image.getStyle().setRelativePosition(_value.getInteger()); break; 
  ...
  public void setDefaultValue (int _index) {
    switch (_index) {
      ...
      case 2 : image.getStyle().setRelativePosition(Style.CENTERED); break; 
