...
// ------------------------------------------------
  ...
  public String getPropertyInfo(String _property) {
    ...
    if (_property.equals("resolution"))   return "3DResolution|String|Object";
      ...
      while (tokenizer.hasMoreTokens()) {
        ...
        try {
          if (keyword.startsWith("x:") || keyword.startsWith("y:") || keyword.startsWith("z:") ) {
            ...
            if (angleStr.endsWith("º") || angleStr.endsWith("d") ) { 
            ...
            if (!t.hasMoreTokens()) {
              boolean degrees = false;
              if (firstToken.endsWith("º") || firstToken.endsWith("d")) { 
