...
public class EditorForVariables {
  ...
  static private JList list=null;
...
//  static private JRadioButton leftButton,centerButton,rightButton;
  ...
  static private String[] predefinedActions = ResourceUtil.tokenizeString(sysRes.getString("EditorForVariables.ActionList"));
...
//  }
  ...
  public static boolean isPredefinedAction (String _action) {
...
//          data.add("_isEmersionConnected() : "+res.getOptionalString("EditorForVariables.isEmersionConnected"));
        }
        // List custom methods
