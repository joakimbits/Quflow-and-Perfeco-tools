...
public class SearchDialog {
  ...
  private JCheckBox caseCheckbox,descCB, modelCB, viewCB;
  ...
  public SearchDialog (Osejs _ejs, JComponent _parentComponent) {
    ...
    buttonPanel.add(partsFinalPanel,BorderLayout.WEST);
    ...
    dialog.setSize (res.getDimension("SearchDialog.Size"));
    dialog.validate();
  ...
  private void doTheSearch() {
    ...
    if (viewCB.isSelected()) searchIn = searchIn | SearchResult.SEARCH_VIEW;
