...
//      System.out.println("Reading "+ _file.getName()+ " with charset "+_charset);
      Reader reader = _charset==null ? new FileReader(_file) : new InputStreamReader(new FileInputStream(_file),_charset);
...
//  }
  ...
  static public boolean isWritable (File _file) {
    ...
    try {
      File tmp = File.createTempFile("_ejs_tmp_", ".xml", dir);
