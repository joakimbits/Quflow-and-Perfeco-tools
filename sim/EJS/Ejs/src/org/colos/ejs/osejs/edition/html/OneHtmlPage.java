...
public class OneHtmlPage {
  ...
  public void setCode (String _code) {
    ...
    else editablePage.setHtml(editor.convertToAbsolute(_code));
  }
...
//    else editablePage.setFont(_font);
  ...
  public StringBuffer getHtmlCode (String _info) { // The code for the generated HTML file
    ...
    htmlCode = HtmlEditor.convertSRCtags(editor.getEjs(),htmlCode,HtmlEditor.TO_REQUIRED_BY_HTML);
...
//    if (externalPage!=null) externalPage.refresh(_hiddensToo);
//  }
