...
//    builder.toBeRemoved = _toBeRemovedWhenRebuilding;
   ...
   */
  public void run () {
    String rootName   = FileUtils.getPlainName(target);
    ...
    String label = res.getString("Generate.HtmlEjsGenerated")+" Easy Java Simulations "+org.colos.ejs.library._EjsConstants.VERSION;
...
//    minijar.setVerbose(false);
    ...
    for (PathAndFile metadataPathAndFile : simulationMetadataFiles) {
      ...
      println (output,res.getString("Package.ProcessingSimulation") + " "+FileUtils.getPlainName(metadataPathAndFile.getFile()));
...
//    boolean launcherSucceeded = true;
  ...
  static private StringBuffer processSimulationFiles (MiniJar _minijar, String _binDirPath, String _outputDirPath, File _sourceDir,
    ...
    String plainName = FileUtils.getPlainName(_metadataPathAndFile.getFile());
