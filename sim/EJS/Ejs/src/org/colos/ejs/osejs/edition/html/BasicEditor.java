...
class BasicEditor implements HtmlComponent {
  ...
  static private String baseText=""; // "<html><head><link type=\"textPane/css\" rel=\"stylesheet\" href=\"_library/css/ejsPage.css\"></head><body> </body></html>";
...
//    vcTools.add(EkitCore.KEY_TOOL_STYLES);
    ...
    topPanel.add(ekitCore.customizeToolBar(EkitCore.TOOLBAR_MAIN, vcTools, true));
