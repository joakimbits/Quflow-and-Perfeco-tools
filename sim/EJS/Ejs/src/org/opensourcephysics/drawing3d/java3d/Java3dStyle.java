	...
	private void setTexture(Object[] textures, double transparency, boolean combine){
	  ...
	  if (textures[0]!=null) {
	    if (textures[0] instanceof BufferedImage){		
	      ...
	      java.net.URL url = ResourceLoader.getResource(textures[0].toString()).getURL();
	      texture1 = new TextureLoader(url,TextureLoader.GENERATE_MIPMAP | TextureLoader.Y_UP,null).getTexture();
      ...
      if (textures[1] instanceof BufferedImage) texture2 = new TextureLoader((BufferedImage)textures[1],TextureLoader.GENERATE_MIPMAP | TextureLoader.Y_UP).getTexture();
        ...
        texture2 = new TextureLoader(url,TextureLoader.GENERATE_MIPMAP | TextureLoader.Y_UP,null).getTexture();
      }
