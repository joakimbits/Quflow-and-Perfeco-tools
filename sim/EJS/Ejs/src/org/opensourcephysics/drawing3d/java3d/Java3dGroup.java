...
//			  if(elementJ3D instanceof ElementObjectVRML)
//				  ((Java3dElementObjectVRML)elementJ3D.getImplementingObject()).setVRMLVisible(this.element.isVisible() ? elementJ3D.isVisible() : this.element.isVisible());
//			  else if(elementJ3D instanceof ElementObject3DS)
//				  ((Java3dElementObject3DS)elementJ3D.getImplementingObject()).set3DSVisible(this.element.isVisible() ? elementJ3D.isVisible() : this.element.isVisible());
//			  else 
//				  ((Java3dElement)elementJ3D.getImplementingObject()).getAppearance().
//			  			getRenderingAttributes().setVisible(this.element.isVisible() ? elementJ3D.isVisible() : this.element.isVisible());
//		  }
//	  }
//  }
