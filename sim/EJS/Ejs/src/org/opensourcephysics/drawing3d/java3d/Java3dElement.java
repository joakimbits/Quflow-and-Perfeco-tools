...
public abstract class Java3dElement implements ImplementingObject {
  ...
  private void modifyTransform () {
    ...
    if(Double.isNaN(quatBuffer1.x)) quatBuffer1.x = 0.0;
    if(Double.isNaN(quatBuffer1.y)) quatBuffer1.y = 0.0;
    if(Double.isNaN(quatBuffer1.z)) quatBuffer1.z = 0.0;
    if(Double.isNaN(quatBuffer1.w)) quatBuffer1.w = 0.0;
