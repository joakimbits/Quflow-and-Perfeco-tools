...
//    impl = isJava3DInstalled ? IMPLEMENTATION_JAVA3D : IMPLEMENTATION_SIMPLE3D;
   ...
   */
  public boolean setImplementation(int _implementation) {
    ...
    if (_implementation==IMPLEMENTATION_JAVA3D && !isJava3DInstalled) {
      if (!askedToInstallJava3D) {
        ...
        if (option==0)  org.opensourcephysics.desktop.OSPDesktop.displayURL("http://java.sun.com/javase/technologies/desktop/java3d"); 
 ...
 // ------------------------------------
  ...
  public void update() { implementingPanel.update(); }
