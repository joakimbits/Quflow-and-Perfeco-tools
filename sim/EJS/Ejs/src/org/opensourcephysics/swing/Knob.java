...
public class Knob extends javax.swing.JPanel {
  ...
  public void setValue(double _value) {
    ...
    double newAngle = minAngle + (_value-minValue)*(maxAngle-minAngle)/(maxValue-minValue);
    if (newAngle!=angle) {
      angle = newAngle;
      applyAngle();
    }
   ...
   * @param _value
   */
  public void setMaxValue(double _value) { maxValue = _value; }

  /**
   * Sets the value that corresponds to the minimum rotation of the knob. Default is -1
   * @param _value
   */
  public void setMinValue(double _value) { minValue = _value; }
