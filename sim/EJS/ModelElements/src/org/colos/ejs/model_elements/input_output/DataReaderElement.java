...
public class DataReaderElement implements ModelElement {
  static ImageIcon ELEMENT_ICON = ResourceLoader.getIcon("org/colos/ejs/model_elements/input_output/DataReader.png"); // This icon is included in this jar
  ...
  public void showHelp(Component _parentComponent) {
    if (helpDialog==null) { // create the dialog
      helpDialog = new JDialog((JFrame) null,"Data reader: "+ getGenericName());
  ...
  public void showEditor(String _name, Component _parentComponent, ModelElementsCollection _collection) {
    ...
    if (editorDialog==null) { // create the dialog
      field.getDocument().addDocumentListener (new DocumentListener() {
        public void changedUpdate(DocumentEvent e) { elementsCollection.reportChange(DataReaderElement.this); }
        public void insertUpdate(DocumentEvent e)  { elementsCollection.reportChange(DataReaderElement.this); }
        public void removeUpdate(DocumentEvent e)  { elementsCollection.reportChange(DataReaderElement.this); }
      });
      ...
      fileButton.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e) {
          String filename = elementsCollection.chooseFilename(field, "Data reader file chooser", "Data files", "xml,txt");
          if (filename!=null) field.setText("\""+filename+"\"");
        }
      });
      ...
      editorDialog = new JDialog((JFrame) null,"Data reader: "+ _name);
